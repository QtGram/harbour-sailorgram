...
Item
{
    ...
    Column
    {
        ...
        Label
        {
            ...
            width: parent.width
            color: TelegramHelper.isServiceMessage(message) ? Theme.primaryColor : (message.out ? Theme.highlightColor : Theme.primaryColor)
            ...
            text: TelegramHelper.isServiceMessage(message) ? TelegramAction.actionType(context.telegram, dialog, message) : messageitem.message.message
